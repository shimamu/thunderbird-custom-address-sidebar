(function() {
    ...
    function initCustom() {
        ...
        asbcustom.customPrefs.setUnicharPref("ldap_2.servers.default.attrmap.Department", "ou,department,departmentnumber,orgunit");
    }
    ...
    */
    ...
    function loadSearchRange() {
        ...
        for (var i = 0; i < fieldPrefName.length; i++) {
            gSearchRange[i] = asbcustom.customPrefs.getBoolPref(fieldPrefName[i], true);
        }
    }
    ...
    asbcustom.AddressBookMenuListChange_2nd = AddressBookMenuListChange_2nd;
    asbcustom.onEnterInSearchBar_2nd = onEnterInSearchBar_2nd;
}());
